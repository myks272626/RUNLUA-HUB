--[[
    RUNLUA UI Library
    Extracted/rebuilt from the supplied RUNLUA HUB UI structure.

    Design:
      - Dark Navy / Blue
      - Mobile-first responsive layout
      - Draggable window
      - Sidebar tabs with compact/mobile mode
      - Animated Toggle / Button / Label / Section / Divider
      - Dropdown / Slider / TextBox / Keybind
      - PlayerList
      - Notification queue
      - Theme + configuration overrides
      - Destroy / Hide / Show / Toggle
      - No game-specific/MM2 logic is included.
    ...
    Basic usage:
        ...
        Main:Section({Title = "General"})
        Main:Toggle({
            Name = "Example Toggle",
            Description = "Reusable switch",
            Default = false,
